      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        <div>
          ...
          <div className="start-buttons-container">
            <button className="start-buttons" type='button' onClick={()=>router.push('/characterInfo')}>New Game</button>
            <button className="start-buttons" type='button' onClick={()=>router.push('/lobby')}>Join Game</button>
